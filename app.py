...
@st.cache_data
def load_geojson():
    # Пробуем загрузить подготовленный файл
...
def preprocess_stats(df):
    ...
    # Приводим к единому стилю (с Большой буквы)
...
if not df_raw.empty:
    ...
    with tab1:
        ...
        st.info(
            "ℹ️ **Легенда статусов:** 👑 — Работник ЮЦ (штатный) | ⚠️ — Сотрудник сейчас не работает в регионе")
